...
const DongPhucGym = () => {
  ...
  const structuredData = {
    ...
    "url": "https://dongphucunivi.com/san-pham/dong-phuc-chay-bo",
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "position": 3,
          "name": "Đồng phục Gym",
          "item": "https://dongphucunivi.com/san-pham/dong-phuc-chay-bo"
        }
      ]
    },
    "mainEntity": {
...
export async function getServerSideProps() {
  const meta = {
    ...
    robots: "index, follow",
    canonical: "https://dongphucunivi.com/san-pham/dong-phuc-chay-bo",
    og: {
      title: "Đồng phục Chạy bộ - Đồng phục Univi",
      description: "Univi chuyên may đồng phục chạy bộ cho cá nhân & CLB. Chất liệu mềm mại, chống ma sát, thiết kế thoải mái vận động. In logo đội nhóm. Khám phá ngay!",
      type: "website",
