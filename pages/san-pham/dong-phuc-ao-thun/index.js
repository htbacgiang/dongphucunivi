...
const DongPhucGym = () => {
  ...
  const structuredData = {
    ...
    "url": "https://univisport.vn/san-pham/dong-phuc-ao-thun",
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "position": 3,
          "name": "Đồng phục Gym",
          "item": "https://univisport.vn/san-pham/dong-phuc-ao-thun"
        }
      ]
    },
    "mainEntity": {
            ...
            >
              <ul className="uppercase cursor-pointer font-semibold">
                {categories.map((category, index) => {
                  ...
                  const isGymCategory = category === 'Đồng phục áo thun';
...
export async function getServerSideProps() {
  const meta = {
    ...
    robots: "index, follow",
    canonical: "https://univisport.vn/san-pham/dong-phuc-ao-thun",
    og: {
      title: "Đồng phục Gym - Đồng phục Univi | Bộ sưu tập thể thao chất lượng",
