...
const DongPhucGym = () => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Gym - Univi Sport`,
    "description": `Khám phá bộ sưu tập đồng phục gym chất lượng cao từ Univi Sport, thiết kế hiện đại, thoải mái và phù hợp cho mọi hoạt động thể thao.`,
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Đồng phục Gym",
          "item": "https://univisport.vn/san-pham/dong-phuc-gym"
        }
      ]
    },
    "mainEntity": {
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full h-[30vh] md:h-[40vh]">
        <Image
          ...
          alt={`Đồng phục Gym Univi Sport - Bộ sưu tập thể thao chất lượng cao`}
          fill
      ...
      <div className="min-h-screen bg-gray-100 p-4 md:p-6">
        <div className="flex flex-col lg:flex-row gap-6">
          <aside className="w-full lg:w-1/5 bg-white shadow-md p-4 rounded-lg">
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ease-in-out ${isCategoryOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'} lg:max-h-full lg:opacity-100`}
            >
              <ul className="uppercase cursor-pointer font-semibold">
                {categories.map((category, index) => (
                  <li
                    key={index}
                    className="py-2 text-gray-700 cursor-pointer hover:text-black flex justify-between items-center hover:translate-x-2 transition-all duration-300"
                  >
                    <Link href={`/san-pham/${removeDiacritics(category).toLowerCase().replace(/\s+/g, '-')}`}>
                      {category}
                    </Link>
                    ...
                    {category === 'Đồng phục Golf - Tennis' && (
            ...
            <div className="mt-4 hidden md:block">
              <Link href="/khuyen-mai" className="block">
                <Image
                  src="/banner-4.jpg"
                  alt="Khuyến mãi Univi Sport - Ưu đãi đặc biệt cho đồng phục thể thao"
                  width={200}
                  height={400}
              ...
              <div className="flex items-center gap-2 z-0">
                <div className="relative">
                  <select
                    value={sortOption}
                    onChange={handleSort}
                    className="appearance-none p-2 pl-4 pr-8 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700"
                ...
                <div className="flex gap-2">
                  <div className="flex gap-2 lg:hidden">
                    <button
                      ...
                      className={`p-2 rounded-lg ${layout === 'grid' ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-700'}`}
                    ...
                    <button
                      ...
                      className={`p-2 rounded-lg ${layout === 'list' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'}`}
                  ...
                  <div className="hidden lg:flex gap-2">
                    ...
                    <button
                      onClick={() => setLayout('list')}
                      className={`p-2 rounded-lg ${layout === 'list' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'}`}
                      aria-label="Hiển thị sản phẩm dạng danh sách"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative hidden lg:block">
                  <input
                    ...
                    value={searchQuery}
                    onChange={handleSearch}
                    className="pl-10 p-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 w-48"
                    aria-label="Tìm kiếm sản phẩm đồng phục gym"
                  />
                  <svg
...
export async function getServerSideProps() {
  const meta = {
    title: "Đồng phục Gym - Univi Sport | Bộ sưu tập thể thao chất lượng",
    description: "Khám phá bộ sưu tập đồng phục gym từ Univi Sport với thiết kế hiện đại, chất liệu thoải mái, phù hợp cho mọi hoạt động thể thao.",
    keywords: "đồng phục gym, Univi Sport, quần áo thể thao, đồng phục thể thao, thiết kế gym, thể thao chất lượng",
    author: "Univi Sport",
    robots: "index, follow",
    canonical: "https://univisport.vn/san-pham/dong-phuc-gym",
    og: {
      title: "Đồng phục Gym - Univi Sport | Bộ sưu tập thể thao chất lượng",
      description: "Khám phá đồng phục gym chất lượng cao từ Univi Sport, thiết kế hiện đại và thoải mái cho mọi hoạt động thể thao.",
      type: "website",
      image: "https://univisport.vn/images/banner-univi.png",
      imageWidth: "1200",
      imageHeight: "630",
      url: "https://univisport.vn/san-pham/dong-phuc-gym",
      siteName: "Univi Sport",
      locale: "vi_VN",
    },
    twitter: {
      card: "summary_large_image",
      title: "Đồng phục Gym - Univi Sport | Bộ sưu tập thể thao chất lượng",
      description: "Khám phá đồng phục gym từ Univi Sport với thiết kế hiện đại và chất liệu thoải mái.",
      image: "https://univisport.vn/images/banner-univi.png",
      site: "@UniviSport", // Replace with actual Twitter handle if available
    },
  };
