  ...
  return (
    <article className="max-w-full text-base">
      ...
      <section className="prose max-w-none">
        {/* Phần 1: Giới thiệu UNIVI Sport */}
        <div className="">
          <p>
            Chào mừng bạn đến với trang tổng quan sản phẩm của <strong>UNIVI Sport</strong> – nơi quy tụ những bộ đồng phục thể thao chuyên dụng được thiết kế và sản xuất theo tiêu chuẩn chất lượng hàng đầu tại Việt Nam. Chúng tôi hiểu rằng trang phục không chỉ là quần áo, mà còn là một công cụ hỗ trợ đắc lực giúp bạn tối ưu hiệu suất tập luyện, cảm thấy thoải mái và tự tin trong mọi hoạt động.
          </p>
          <p>
            Với sự nghiên cứu chuyên sâu về chất liệu và am hiểu đặc thù của từng bộ môn, UNIVI Sport mang đến đa dạng các dòng sản phẩm, đáp ứng nhu cầu khắt khe nhất của cả người tập luyện cá nhân lẫn các chuỗi phòng tập và doanh nghiệp.
          </p>
          <div className="my-8">
            <Image
              src="/images/univi-sport-intro.jpg"
              alt="Đồng phục thể thao chuyên dụng UNIVI Sport"
              width={800}
              height={600}
              className="rounded"
            />
        ...
        {/* Phần 2: Câu chuyện UNIVI Sport */}
        <h2>Câu Chuyện Đằng Sau UNIVI Sport: Đam Mê Kiến Tạo Giá Trị</h2>
        <p>
          UNIVI Sport được hình thành từ chính tình yêu và niềm đam mê cháy bỏng với thể thao của những người sáng lập. Là những người gắn bó với gym, yoga, chạy bộ, golf, chúng tôi hiểu rõ tầm quan trọng của một bộ trang phục phù hợp. Chúng tôi không ngừng nghiên cứu chuyên sâu về chất liệu, tìm kiếm những loại vải tốt nhất để giải quyết các vấn đề mà người tập luyện thường gặp phải.
        </p>
        <p>
          Qua các cuộc trao đổi với cả vận động viên và người tập luyện thông thường, UNIVI nhận thấy mối quan ngại lớn về nguy cơ chấn thương cơ và khớp cũng như nhu cầu cần có trang phục hỗ trợ hiệu quả. Chính điều đó đã thôi thúc chúng tôi xây dựng UNIVI Sport với tầm nhìn cung cấp quần áo thể thao chất lượng cao, mang lại sự hỗ trợ, thoải mái và an toàn cho <strong>MỌI NGƯỜI</strong>, ở <strong>MỌI LỨA TUỔI</strong>, trong <strong>MỌI HOẠT ĐỘNG</strong> thể thao.
        </p>

        {/* Phần 3: Tầm nhìn & Sứ mệnh */}
        <h2>Tầm Nhìn & Sứ Mệnh: Nâng Tầm Trải Nghiệm Tập Luyện Việt</h2>
        <p>
          UNIVI Sport khao khát trở thành thương hiệu đồng phục thể thao hàng đầu tại Việt Nam, được tin cậy nhờ vào chất lượng sản phẩm vượt trội và sự thấu hiểu nhu cầu khách hàng. Sứ mệnh của chúng tôi là mang đến những giải pháp đồng phục tối ưu, giúp người Việt tự tin, thoải mái và đạt hiệu suất cao nhất trong hành trình chinh phục mục tiêu sức khỏe và thể chất của mình.
        </p>
        <div className="my-8">
          <Image
            src="/images/univi-sport-vision.jpg"
            alt="Tầm nhìn UNIVI Sport - Nâng tầm trải nghiệm tập luyện"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        {/* Phần 4: Thế mạnh của UNIVI Sport */}
        <h2>Thế Mạnh Vượt Trội Của Đồng Phục UNIVI Sport</h2>
        <p>
          Điều gì tạo nên sự khác biệt của UNIVI Sport? Đó chính là sự kết hợp của chuyên môn, công nghệ, quy trình sản xuất và sự am hiểu thị trường sâu sắc.
        </p>
        ...
        <h2>Khám Phá Các Dòng Sản Phẩm Đồng Phục Thể Thao Chuyên Dụng Của UNIVI Sport</h2>
        <p>
          Tại UNIVI Sport, chúng tôi hiểu rằng mỗi bộ môn thể thao đều có yêu cầu riêng về trang phục. Vì vậy, chúng tôi đã nghiên cứu và phát triển các dòng sản phẩm đồng phục chuyên dụng, sử dụng những chất liệu và công nghệ vải tối ưu để mang lại hiệu suất và sự thoải mái cao nhất cho người tập luyện.
        </p>
        <h3>Đồng phục Gym & Fitness</h3>
        <p>
          Đối với các buổi tập gym cường độ cao, yêu cầu về sự co giãn, thoáng khí và bền bỉ là cực kỳ quan trọng. Đồng phục Gym của UNIVI Sport được thiết kế với form dáng năng động, sử dụng các chất liệu như <strong>UNIVI – QUICK DRY</strong> hoặc <strong>UNIVI – BLENDED</strong> với khả năng thoát ẩm, nhanh khô vượt trội nhờ công nghệ <strong>UNI DRY</strong>. Đường may tinh tế, chắc chắn đảm bảo không gây cọ sát, cho phép bạn thực hiện mọi động tác nâng tạ, squat hay cardio một cách thoải mái và hiệu quả tối đa.
        </p>
        <p>
        ...
        <div className="my-8">
          <Image
            ...
            alt="Đồng phục Gym & Fitness UNIVI Sport"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        <div className="my-8">
          <Image
            ...
            alt="Đồng phục Yoga UNIVI Sport"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        <div className="my-8">
          <Image
            ...
            alt="Đồng phục Chạy Bộ UNIVI Sport"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        <div className="my-8">
          <Image
            ...
            alt="Đồng phục Golf UNIVI Sport"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        <div className="my-8">
          <Image
            ...
            alt="Đồng phục HLV & Nhân viên UNIVI Sport"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        <div className="my-8">
          <Image
            ...
            alt="Đồng phục Sự kiện Thể thao UNIVI Sport"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        {/* Phần 6: Tại sao chọn UNIVI Sport */}
        <h2>Tại Sao Chọn Đồng Phục Thể Thao UNIVI Sport?</h2>
        <p>
          Lý do khiến hàng trăm khách hàng tin tưởng và lựa chọn đồng phục của UNIVI Sport nằm ở những giá trị cốt lõi vượt trội mà chúng tôi mang lại:
        </p>
        <ul>
          <li>
        ...
        <div className="my-8">
          <Image
            ...
            alt="Tại sao chọn đồng phục thể thao UNIVI Sport"
            width={800}
            height={600}
            className="rounded"
          />
        ...
        <h2>Hãy Liên Hệ Với UNIVI Sport!</h2>
        <p>
          Bạn đang tìm kiếm giải pháp đồng phục thể thao cho doanh nghiệp? Hay muốn đặt may đồng phục chuyên dụng cho đội/nhóm của mình? Hãy liên hệ ngay với <strong>UNIVI Sport</strong> để được tư vấn chi tiết về Giải pháp <strong>2S Uniform</strong> và khám phá sự khác biệt về chất lượng sản phẩm của chúng tôi.
        </p>
        ...
        <div className="my-8">
          <Image
            ...
            alt="Liên hệ UNIVI Sport – Đồng phục thể thao chất lượng cao"
            width={800}
            height={600}
            className="rounded"
          />
