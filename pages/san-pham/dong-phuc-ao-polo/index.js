...
import PoloUniformsUniviPage from '../../../components/univisport/bai-viet/PoloUniformsUniviPage';
...
const DongPhucGym = ({ initialProducts }) => {
  const categorySlug = 'dong-phuc-ao-polo';
  ...
  const structuredData = {
    ...
    "url": "https://dongphucunivi.com/san-pham/dong-phuc-ao-polo",
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "position": 3,
          "name": "Đồng phục Gym",
          "item": "https://dongphucunivi.com/san-pham/dong-phuc-ao-polo"
        }
      ]
    },
    "mainEntity": {
...
export async function getServerSideProps() {
  const meta = {
    ...
    description: "Đồng Phục Univi cung cấp quy trình đặt hàng đơn giản, hỗ trợ thiết kế chuyên nghiệp và sản xuất nhanh chóng. Chúng tôi cam kết chất lượng trên từng sản phẩm và giao hàng toàn quốc, giúp bạn tiết kiệm thời gian và công sức. Liên hệ Univi ngay hôm nay!",
    keywords: "đồng phục gym, Đồng phục Univi, quần áo thể thao, đồng phục thể thao, thiết kế gym, thể thao chất lượng",
    author: "Đồng phục Univi",
    robots: "index, follow",
    canonical: "https://dongphucunivi.com/san-pham/dong-phuc-ao-polo",
    og: {
      title: "Đồng phục Áo thun - Đồng phục Univi",
      description: "Đồng Phục Univi cung cấp quy trình đặt hàng đơn giản, hỗ trợ thiết kế chuyên nghiệp và sản xuất nhanh chóng. Chúng tôi cam kết chất lượng trên từng sản phẩm và giao hàng toàn quốc, giúp bạn tiết kiệm thời gian và công sức. Liên hệ Univi ngay hôm nay!",
      type: "website",
