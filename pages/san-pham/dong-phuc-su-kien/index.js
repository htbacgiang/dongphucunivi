...
const DongPhucGym = () => {
  const categorySlug = 'dong-phuc-su-kien';
  ...
  const structuredData = {
    ...
    "url": "https://dongphucunivi.com/san-pham/dong-phuc-su-kien",
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "position": 3,
          "name": "Đồng phục Gym",
          "item": "https://dongphucunivi.com/san-pham/dong-phuc-su-kien"
        }
      ]
    },
    "mainEntity": {
...
export async function getServerSideProps() {
  const meta = {
    title: "Đồng phục Sự kiện - Đồng phục Univi",
    description: "Đồng Phục Univi tự hào là đối tác cung cấp giải pháp đồng phục sự kiện toàn diện cho doanh nghiệp, tổ chức và cá nhân. Từ những chiếc áo thun năng động cho team building, áo polo lịch sự cho hội thảo, đến những bộ vest chỉn chu cho sự kiện quan trọng, chúng tôi đều đáp ứng với chất lượng vượt trội, thiết kế sáng tạo và tiến độ nhanh chóng",
    author: "Đồng phục Univi",
    robots: "index, follow",
    canonical: "https://dongphucunivi.com/san-pham/dong-phuc-su-kien",
    og: {
      title: "Đồng phục Sự kiện - Đồng phục Univi",
    description: "Đồng Phục Univi tự hào là đối tác cung cấp giải pháp đồng phục sự kiện toàn diện cho doanh nghiệp, tổ chức và cá nhân. Từ những chiếc áo thun năng động cho team building, áo polo lịch sự cho hội thảo, đến những bộ vest chỉn chu cho sự kiện quan trọng, chúng tôi đều đáp ứng với chất lượng vượt trội, thiết kế sáng tạo và tiến độ nhanh chóng",
      type: "website",
