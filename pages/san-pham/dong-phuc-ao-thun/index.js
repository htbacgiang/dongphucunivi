...
export async function getServerSideProps() {
  const meta = {
    ...
    description: "Đặt may áo thun đồng phục Univi: Vải cotton, thun lạnh cao cấp, thoáng mát, bền đẹp. Form chuẩn, nhiều màu sắc. Hoàn hảo cho đội nhóm, lớp, CLB. Xem mẫu!",
