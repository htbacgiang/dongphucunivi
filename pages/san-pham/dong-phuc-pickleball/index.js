...
const DongPhucGym = () => {
  ...
  const structuredData = {
    ...
    "url": "https://univisport.vn/san-pham/dong-phuc-pickleball",
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "position": 3,
          "name": "Đồng phục Gym",
          "item": "https://univisport.vn/san-pham/dong-phuc-pickleball"
        }
      ]
    },
    "mainEntity": {
...
export async function getServerSideProps() {
  const meta = {
    ...
    robots: "index, follow",
    canonical: "https://univisport.vn/san-pham/dong-phuc-pickleball",
    og: {
      title: "Đồng phục Gym - Đồng phục Univi | Bộ sưu tập thể thao chất lượng",
